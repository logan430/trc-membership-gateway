...
<objective>
Create member and admin API endpoints for point history and management

Purpose: Allow members to view their earned points and history (GAME-05, GAME-06). Allow admins to adjust points with audit trail (GAME-07). All APIs use cursor pagination matching existing patterns.
...
- File exports pointsRouter
  ...
  <done>Member can query their point history and summary via authenticated API</done>
</task>
