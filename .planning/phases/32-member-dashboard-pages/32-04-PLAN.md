       ...
       <div className="relative">
         ...
         <div className="blur-sm opacity-50 pointer-events-none">
           <div className="grid grid-cols-2 gap-4">
             {[1, 2, 3, 4].map((i) => (
               <Card key={i} className="h-32 bg-accent" />
             ))}
           </div>
         </div>
         ...
         <div className="absolute inset-0 flex items-center justify-center">
           <Card className="p-6 text-center max-w-md pixel-border border-gold/30">
      ...
      <div className="flex gap-2 overflow-x-auto pb-2">
        {(Object.keys(categoryLabels) as BenchmarkCategory[]).map((cat) => (
          <button
            ...
            className={`px-4 py-2 text-sm font-medium whitespace-nowrap rounded-[8px] transition-colors ${
              category === cat
        ...
        <Card className="p-4">
          <div className="flex flex-wrap gap-4">
            <select
              ...
              className="px-3 py-2 border border-input bg-background rounded-[8px]"
            >
      ...
      {hasInsufficientData ? (
        ...
        <div className="space-y-8">
          ...
          {aggregates?.available?.filter(a => a.yourValue !== undefined).map((field) => {
            ...
            return (
              <Card key={field.field} className="p-6">
                <ComparisonBar
                  label={format.label}
